...
const Services = () => {
    return (
        <div className='container mx-auto my-20'>
            ...
            <div className="flex justify-center mx-5 md:mx-0 lg:mx-0">
                <div className="mt-10  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-center max-w-[1200px]">
                    <div className="card card-compact text-center w-[375px] bg-base-100 py-14 shadow-xl">
