...
const HeaderHighlight = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 container mx-auto my-10 text-white'>
            <div className="card card-side bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-4 lg:px-8 lg:py-8 shadow-xl mx-5 md:mx-0 lg:mx-0">
            ...
            <div className="card card-side bg-accent px-4 py-4 lg:px-8 lg:py-8 shadow-xl mx-5 md:mx-0 lg:mx-0">
